...
class _$_CreateChatRequest implements _CreateChatRequest {
  _$_CreateChatRequest(
      ...
      @JsonKey(name: 'is_group_chat') this.isGroupChat,
      this.name});
  ...
  @override
  String toString() {
    return 'CreateChatRequest(userId: $userId, isGroupChat: $isGroupChat, name: $name)';
  }
...
abstract class _CreateChatRequest implements CreateChatRequest {
  factory _CreateChatRequest(
      ...
      @JsonKey(name: 'is_group_chat') final bool? isGroupChat,
